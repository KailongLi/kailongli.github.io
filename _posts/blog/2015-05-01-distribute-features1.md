...
在开始分析 copycat 中 Leader election 实现代码之前，建议阅读[copycat][]仓库代码下面的描述，有助于理解 Resource, Log, Cluster 等名词含义。引用 copycat 的一段话，来描述 resource, Cluster, LeaderElection, event log 的关系，如下：
...
![resource-leader-ship-event-log-cluster-relationship](/images/githubpages/resource-leader-ship-event-log-cluster-relationship.png)

为了确保大家看的代码都是一样的，需要将代码切换到 commit hash 为 d597c723ffe9dbbee2aa22f4bd68d8174410e054 的版本。
